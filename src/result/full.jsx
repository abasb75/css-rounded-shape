...
import getFullCssResult from "../functions/getFullCssResult";
import getFullTailwindResult from "../functions/getFullTailwindResult";
import copy from "../functions/copy";
import { resetShapeRadius } from "../store/shapeRadius";

function FullResult(){
    const shapeSize = useSelector(s=>s.shapeSize);
    const shapeRadius = useSelector(s=>s.shapeRadius);
    const cssResult = getFullCssResult(shapeRadius);
    const tailwindResult = getFullTailwindResult(shapeRadius);
    ...
    return (<div className="border-l-[1px] border-slate-100 h-full p-4 flex-1">
        ...
        <div className="py-4">
            <button 
            onClick={()=>dispatch(resetShapeRadius())}
